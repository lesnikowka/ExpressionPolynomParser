...
protected:
	...
	std::vector<std::pair<int, int>> v5 = { {-4, 0}, {-3, 0}, {-10, 0}, {-7, 0}, {-12, 0}, {-6, 0}, {-8,0}, {-9,0} };
};
...
TEST_F(AVL_fixture, can_do_simple_left_rotate_during_the_insert) {
...
TEST_F(AVL_fixture, can_do_simple_right_rotate_during_the_insert) {
...
TEST_F(AVL_fixture, can_do_big_left_rotate_during_the_insert) {
...
TEST_F(AVL_fixture, can_do_big_right_rotate_during_the_insert) {
