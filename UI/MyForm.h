...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->неупорядоченнаяТаблицаToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::неупорядоченнаяТаблицаToolStripMenuItem_Click);
			// 
			...
			this->хештаблицаметодЦепочекToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::хештаблицаметодЦепочекToolStripMenuItem_Click);
			// 
